...
@section('meta_description', 'Best, affordable, and attractive web development services in Ghaziabad. SEO-ready custom websites, ecommerce builds, UI UX, and long-term maintenance for business growth.')
@section('meta_keywords', 'best web development company ghaziabad, affordable website development ghaziabad, custom website development ghaziabad, ecommerce website development ghaziabad, responsive web design ghaziabad, laravel development ghaziabad, business website design ghaziabad, indirapuram web development, vaishali website developer, seo friendly website company ghaziabad')
...
@include('website.pages.services.partials.location-seo-kit', ['mode' => 'schema', 'serviceKey' => 'web', 'cityKey' => 'ghaziabad'])
@endpush
...
<section class="py-5" style="background:linear-gradient(180deg,#fff7ed 0%,#ffffff 100%); border-top:1px solid #fed7aa; border-bottom:1px solid #ffedd5;">
  <div class="container">
    ...
    <h2 style="font-weight:800; color:#7c2d12; margin-top:12px;">Best, Affordable and Business-Ready Web Development in Ghaziabad</h2>
...
@include('website.pages.services.partials.location-seo-kit', ['mode' => 'content', 'serviceKey' => 'web', 'cityKey' => 'ghaziabad'])
@endsection