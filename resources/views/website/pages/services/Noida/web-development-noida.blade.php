...
@section('meta_description', 'Best, affordable, and attractive web development services in Noida. SEO-ready custom websites, ecommerce builds, UI UX, and long-term maintenance for business growth.')
@section('meta_keywords', 'best web development company noida, affordable website development noida, custom website development noida, ecommerce website development noida, responsive web design noida, laravel development noida, react web developer noida, web application development noida, seo friendly website company noida, business website design noida')
...
@include('website.pages.services.partials.location-seo-kit', ['mode' => 'schema', 'serviceKey' => 'web', 'cityKey' => 'noida'])
@endpush
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        {"@@type": "ListItem", "position": 4, "name": "Web Development Noida", "item": "https://shivatechdigital.com/services/web-development-noida"}
    ]
}
</script>
@endsection
...
<section class="py-5" style="background:linear-gradient(180deg,#fff7ed 0%,#ffffff 100%); border-top:1px solid #fed7aa; border-bottom:1px solid #ffedd5;">
  <div class="container">
    ...
    <h2 style="font-weight:800; color:#7c2d12; margin-top:12px;">Best, Affordable and SEO-Focused Web Development in Noida</h2>
    ...
    <div class="row g-4">
      <div class="col-lg-4 col-md-6">
        <div class="h-100 p-4" style="background:#ffffff; border:1px solid #fdba74; border-radius:14px; box-shadow:0 10px 24px rgba(124,45,18,.08);">
          <h3 style="font-size:1.05rem; font-weight:700; color:#7c2d12;">Best Web Development in Noida</h3>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="h-100 p-4" style="background:#ffffff; border:1px solid #fdba74; border-radius:14px; box-shadow:0 10px 24px rgba(124,45,18,.08);">
          <h3 style="font-size:1.05rem; font-weight:700; color:#7c2d12;">Affordable Web Development in Noida</h3>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="h-100 p-4" style="background:#ffffff; border:1px solid #fdba74; border-radius:14px; box-shadow:0 10px 24px rgba(124,45,18,.08);">
          <h3 style="font-size:1.05rem; font-weight:700; color:#7c2d12;">Attractive and Modern Web Development in Noida</h3>
...
@include('website.pages.services.partials.location-seo-kit', ['mode' => 'content', 'serviceKey' => 'web', 'cityKey' => 'noida'])
@endsection