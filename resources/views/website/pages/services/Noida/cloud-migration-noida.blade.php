...
@section('meta_description', 'Best, affordable, and secure cloud migration services in Noida. AWS Azure GCP migration, architecture modernization, cost optimization, and managed cloud support.')
@section('meta_keywords', 'best cloud migration company noida, affordable cloud migration noida, aws migration noida, azure migration noida, gcp migration noida, cloud consulting noida, server migration noida, cloud modernization noida, managed cloud support noida, cloud architect noida')
...
@include('website.pages.services.partials.location-seo-kit', ['mode' => 'schema', 'serviceKey' => 'cloud', 'cityKey' => 'noida'])
@endpush
...
<section class="py-5" style="background:linear-gradient(180deg,#fff7ed 0%,#ffffff 100%); border-top:1px solid #fed7aa; border-bottom:1px solid #ffedd5;">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <h2 style="font-weight:800; color:#7c2d12; margin-top:12px;">Best, Affordable and Secure Cloud Migration in Noida</h2>
    ...
    <div class="row g-4">
      <div class="col-lg-4 col-md-6">
        <div class="h-100 p-4" style="background:#ffffff; border:1px solid #fdba74; border-radius:14px; box-shadow:0 10px 24px rgba(124,45,18,.08);">
          <h3 style="font-size:1.05rem; font-weight:700; color:#7c2d12;">Best Cloud Migration in Noida.Blade</h3>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="h-100 p-4" style="background:#ffffff; border:1px solid #fdba74; border-radius:14px; box-shadow:0 10px 24px rgba(124,45,18,.08);">
          <h3 style="font-size:1.05rem; font-weight:700; color:#7c2d12;">Affordable Cloud Migration in Noida.Blade</h3>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="h-100 p-4" style="background:#ffffff; border:1px solid #fdba74; border-radius:14px; box-shadow:0 10px 24px rgba(124,45,18,.08);">
          <h3 style="font-size:1.05rem; font-weight:700; color:#7c2d12;">Attractive and Modern Cloud Migration in Noida.Blade</h3>
...
@include('website.pages.services.partials.location-seo-kit', ['mode' => 'content', 'serviceKey' => 'cloud', 'cityKey' => 'noida'])
@endsection