            ...
            <div class="card reply-card">
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="original-comment-box">
                        ...
                        <div class="meta-text small mb-2">Original Comment:</div>
                    ...
                    <form action="{{ route('admin.comments.reply.update', ['comment' => $comment->id, 'reply' => $reply->id]) }}" method="POST">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label class="form-label">Edit Reply *</label>
                            <textarea name="comment" rows="6" class="form-control @error('comment') is-invalid @enderror" required>{{ old('comment', $reply->comment) }}</textarea>
                            @error('comment')
