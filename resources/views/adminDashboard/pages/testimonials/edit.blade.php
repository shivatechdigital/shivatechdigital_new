...
<style>
    ...
    .current-photo img { width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid var(--tf-border); }
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="client_role" class="form-control @error('client_role') is-invalid @enderror"
                                    value="{{ old('client_role', $testimonial->client_role) }}" placeholder="e.g. CEO">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="client_company" class="form-control @error('client_company') is-invalid @enderror"
                                    value="{{ old('client_company', $testimonial->client_company) }}" placeholder="e.g. ABC Pvt Ltd">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="service_type" class="form-select @error('service_type') is-invalid @enderror">
                                    ...
                                    @foreach(['Web Development','Mobile App Development','UI/UX Design','E-commerce Development','Digital Marketing','SEO Services','Social Media Marketing','Content Marketing','Cloud Solutions','Branding','Graphic Design','Video Production','Maintenance & Support'] as $svc)
                                        <option value="{{ $svc }}" {{ old('service_type', $testimonial->service_type) === $svc ? 'selected' : '' }}>{{ $svc }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                @if($testimonial->client_photo)
                                    <div class="current-photo mb-2">
                                        ...
                                        <div class="form-text text-muted mt-1">Current photo. Upload new to replace.</div>
                                    </div>
                                @endif
                                ...
                                <div class="form-text text-muted">PNG, JPG, WebP – max 2MB.</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="is_featured" class="form-select @error('is_featured') is-invalid @enderror" required>
                                    <option value="1" {{ old('is_featured', $testimonial->is_featured ? '1' : '0') == '1' ? 'selected' : '' }}>Yes – Show on Home</option>
                                    <option value="0" {{ old('is_featured', $testimonial->is_featured ? '1' : '0') == '0' ? 'selected' : '' }}>No</option>
                                </select>
